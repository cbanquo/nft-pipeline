...
from src.pipelines.autoglyphs_transfers_pipeline import AutoglyphsTranfersPipeline, TABLE_NAME, TIMESTAMP_COL
...
class TestArtBlocksSalesPipeline:
    ...
    @pytest.fixture(scope="class")
    def instance(self) -> AutoglyphsTranfersPipeline:
        return AutoglyphsTranfersPipeline()
