...
from src.pipelines.bayc_transfers_pipeline import BAYCTransfersPipeline, TABLE_NAME, TIMESTAMP_COL
...
class TestArtBlocksSalesPipeline:
    ...
    @pytest.fixture(scope="class")
    def instance(self) -> BAYCTransfersPipeline:
        return BAYCTransfersPipeline()
