...
from src.pipelines.crypto_punk_transfers_pipeline import CryptoPunkTransfersPipeline, TABLE_NAME, TIMESTAMP_COL
...
class TestArtBlocksSalesPipeline:
    ...
    @pytest.fixture(scope="class")
    def instance(self) -> CryptoPunkTransfersPipeline:
        return CryptoPunkTransfersPipeline()
