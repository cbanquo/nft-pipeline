...
from src.pipelines.nouns_dao_auction_pipeline import NounsDaoAuctionPipeline, TABLE_NAME, TIMESTAMP_COL
...
class TestArtBlocksSalesPipeline:
    ...
    @pytest.fixture(scope="class")
    def instance(self) -> NounsDaoAuctionPipeline:
        return NounsDaoAuctionPipeline()
