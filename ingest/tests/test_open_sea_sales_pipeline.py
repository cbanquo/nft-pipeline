...
from src.pipelines.open_sea_sales_pipeline import OpenSeaSalesPipeline, TABLE_NAME, TIMESTAMP_COL
from src.config import config


class TestOpenSeaSalesPipelinePipeline:
    ...
    @pytest.fixture(scope="class")
    def instance(self) -> OpenSeaSalesPipeline:
        return OpenSeaSalesPipeline()
